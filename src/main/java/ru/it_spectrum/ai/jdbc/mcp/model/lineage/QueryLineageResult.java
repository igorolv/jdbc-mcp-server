...
public record QueryLineageResult(
        @Schema(description = "Parsed query inspection that underpins lineage (opaque; the inspectQuery tool returns the typed form).", nullable = true, requiredMode = Schema.RequiredMode.NOT_REQUIRED)
