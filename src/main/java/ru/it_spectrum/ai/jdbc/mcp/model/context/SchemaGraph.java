...
public record SchemaGraph(
        ...
        @Schema(description = "Highest-degree tables that are likely hubs in the schema.", nullable = true)
        List<GraphTableSummary> centralTables,
        @Schema(description = "Tables with no visible relationships in the scanned schema graph.", nullable = true)
        List<GraphTableSummary> isolatedTables,
        @Schema(description = "Connected components discovered in the schema relationship graph.", nullable = true)
        ...
        @Schema(description = "Table nodes included in the schema graph response.", nullable = true)
        List<GraphNode> nodes,
        @Schema(description = "Relationship edges included in the graph response.", nullable = true)
        List<GraphEdgeSummary> edges,
        @Schema(description = "Shortest relationship path between the requested source and target tables, when requested.", nullable = true)
